...
VALA_EXTERN void seafile_repo_set_status (SeafileRepo* self,
                              gint value);
VALA_EXTERN const gchar* seafile_repo_get_repo_type (SeafileRepo* self);
VALA_EXTERN void seafile_repo_set_repo_type (SeafileRepo* self,
                                 const gchar* value);
...
VALA_EXTERN void seafile_repo_set_salt (SeafileRepo* self,
                            const gchar* value);
VALA_EXTERN const gchar* seafile_repo_get_pwd_hash (SeafileRepo* self);
VALA_EXTERN void seafile_repo_set_pwd_hash (SeafileRepo* self,
                                const gchar* value);
VALA_EXTERN const gchar* seafile_repo_get_pwd_hash_algo (SeafileRepo* self);
VALA_EXTERN void seafile_repo_set_pwd_hash_algo (SeafileRepo* self,
                                     const gchar* value);
VALA_EXTERN const gchar* seafile_repo_get_pwd_hash_params (SeafileRepo* self);
VALA_EXTERN void seafile_repo_set_pwd_hash_params (SeafileRepo* self,
                                       const gchar* value);
...
VALA_EXTERN void seafile_encryption_info_set_pwd_hash (SeafileEncryptionInfo* self,
                                           const gchar* value);
VALA_EXTERN const gchar* seafile_encryption_info_get_pwd_hash_algo (SeafileEncryptionInfo* self);
VALA_EXTERN void seafile_encryption_info_set_pwd_hash_algo (SeafileEncryptionInfo* self,
                                                const gchar* value);
VALA_EXTERN const gchar* seafile_encryption_info_get_pwd_hash_params (SeafileEncryptionInfo* self);
VALA_EXTERN void seafile_encryption_info_set_pwd_hash_params (SeafileEncryptionInfo* self,
                                                  const gchar* value);
