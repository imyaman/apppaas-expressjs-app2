...
export const config = {
  ...
  // 'relay'    : WS relay to a remote seaf-server (+ optional local seaf-server)
  // 'fullstack': run the ENTIRE x86_64 SeaTable stack here under PRoot, proxy 3000->8080
  runMode: (env.RUN_MODE || 'relay').toLowerCase(),
